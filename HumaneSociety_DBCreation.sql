...
CREATE DATABASE [HumaneSociety]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'HumaneSociety', FILENAME = N'C:\Users\Baron\HumaneSociety.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'HumaneSociety_log', FILENAME = N'C:\Users\Baron\HumaneSociety_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
